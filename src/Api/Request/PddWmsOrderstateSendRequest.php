...
class PddWmsOrderstateSendRequest extends PopBaseHttpRequest
{
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWmsOrderstateSendRequest_Request, "request")
	*/
	private $request;
...
class PddWmsOrderstateSendRequest_Request extends PopBaseJsonEntity
{
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWmsOrderstateSendRequest_RequestOrder, "order")
	*/
	private $order;

	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddWmsOrderstateSendRequest_RequestOrderLinesItem>, "orderLines")
	*/
	private $orderLines;
	...
	*/
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWmsOrderstateSendRequest_RequestProcess, "process")
	*/
	private $process;
