...
class PddWmsInborderConfirmRequest extends PopBaseHttpRequest
{
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWmsInborderConfirmRequest_Request, "request")
	*/
	private $request;
...
class PddWmsInborderConfirmRequest_Request extends PopBaseJsonEntity
{
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWmsInborderConfirmRequest_RequestInbOrder, "inbOrder")
	*/
	private $inbOrder;

	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddWmsInborderConfirmRequest_RequestOrderLinesItem>, "orderLines")
	*/
	private $orderLines;
