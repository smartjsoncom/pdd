...
class PddWmsInborderCreateRequest extends PopBaseHttpRequest
{
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWmsInborderCreateRequest_Request, "request")
	*/
	private $request;
...
class PddWmsInborderCreateRequest_Request extends PopBaseJsonEntity
{
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWmsInborderCreateRequest_RequestInbOrder, "inbOrder")
	*/
	private $inbOrder;

	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddWmsInborderCreateRequest_RequestOrderLineItem>, "orderLine")
	*/
	private $orderLine;
...
class PddWmsInborderCreateRequest_RequestInbOrder extends PopBaseJsonEntity
{
	...
	*/
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWmsInborderCreateRequest_RequestInbOrderMallContracter, "mallContracter")
	*/
	...
	*/
	...
	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddWmsInborderCreateRequest_RequestInbOrderRelatedOrdersItem>, "relatedOrders")
	*/
	...
	*/
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWmsInborderCreateRequest_RequestInbOrderSenderInfo, "senderInfo")
	*/
	private $senderInfo;
