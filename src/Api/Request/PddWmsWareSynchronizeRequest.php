...
class PddWmsWareSynchronizeRequest extends PopBaseHttpRequest
{
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWmsWareSynchronizeRequest_Request, "request")
	*/
	private $request;
...
class PddWmsWareSynchronizeRequest_Request extends PopBaseJsonEntity
{
	...
	*/
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWmsWareSynchronizeRequest_RequestWare, "ware")
	*/
	private $ware;
