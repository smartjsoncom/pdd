...
class PddVirtualCreateMedicineNotifyRequest extends PopBaseHttpRequest
{
	...
	*/
	...
	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddVirtualCreateMedicineNotifyRequest_DrugInfoItem>, "drug_info")
	*/
	private $drugInfo;
	...
	*/
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddVirtualCreateMedicineNotifyRequest_PhysicalFunction, "physical_function")
	*/
