...
class PddWmsDeliveryorderCreateRequest extends PopBaseHttpRequest
{
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWmsDeliveryorderCreateRequest_Request, "request")
	*/
	private $request;
...
class PddWmsDeliveryorderCreateRequest_Request extends PopBaseJsonEntity
{
	...
	*/
	...
	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddWmsDeliveryorderCreateRequest_RequestOrderLinesItem>, "orderLines")
	*/
	private $orderLines;
