...
class PddGoodsLogisticsSerTemplateUpdateRequest extends PopBaseHttpRequest
{
	...
	*/
	...
	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddGoodsLogisticsSerTemplateUpdateRequest_ServiceAreaListItem>, "service_area_list")
	*/
	private $serviceAreaList;

	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddGoodsLogisticsSerTemplateUpdateRequest_CatListItem>, "cat_list")
	*/
	private $catList;
...
class PddGoodsLogisticsSerTemplateUpdateRequest_CatListItem extends PopBaseJsonEntity
{
	...
	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddGoodsLogisticsSerTemplateUpdateRequest_CatListItemListItem>, "list")
	*/
	private $list;
...
class PddGoodsLogisticsSerTemplateUpdateRequest_CatListItemListItem extends PopBaseJsonEntity
{
	...
	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddGoodsLogisticsSerTemplateUpdateRequest_CatListItemListItemContentItem>, "content")
	*/
	private $content;
