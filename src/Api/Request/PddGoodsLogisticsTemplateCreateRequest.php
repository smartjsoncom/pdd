...
class PddGoodsLogisticsTemplateCreateRequest extends PopBaseHttpRequest
{
	...
	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddGoodsLogisticsTemplateCreateRequest_CostTemplateListItem>, "cost_template_list")
	*/
	private $costTemplateList;

	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddGoodsLogisticsTemplateCreateRequest_FreeProvinceListItem>, "free_province_list")
	*/
...
class PddGoodsLogisticsTemplateCreateRequest_CostTemplateListItem extends PopBaseJsonEntity
{
	...
	*/
	...
	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddGoodsLogisticsTemplateCreateRequest_CostTemplateListItemCostProvinceListItem>, "cost_province_list")
	*/
