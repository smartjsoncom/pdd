...
class PddWmsDeliveryorderConfirmRequest extends PopBaseHttpRequest
{
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWmsDeliveryorderConfirmRequest_Request, "request")
	*/
	private $request;
...
class PddWmsDeliveryorderConfirmRequest_Request extends PopBaseJsonEntity
{
	...
	*/
	...
	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddWmsDeliveryorderConfirmRequest_RequestOrderLinesItem>, "orderLines")
	*/
	private $orderLines;
