...
class PddWaybillUpdateRequest extends PopBaseHttpRequest
{
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWaybillUpdateRequest_ParamWaybillCloudPrintUpdateRequest, "param_waybill_cloud_print_update_request")
	*/
...
class PddWaybillUpdateRequest_ParamWaybillCloudPrintUpdateRequest extends PopBaseJsonEntity
{
	...
	*/
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWaybillUpdateRequest_ParamWaybillCloudPrintUpdateRequestPackageInfo, "package_info")
	*/
	private $packageInfo;

	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWaybillUpdateRequest_ParamWaybillCloudPrintUpdateRequestRecipient, "recipient")
	*/
	private $recipient;

	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWaybillUpdateRequest_ParamWaybillCloudPrintUpdateRequestSender, "sender")
	*/
	private $sender;
...
class PddWaybillUpdateRequest_ParamWaybillCloudPrintUpdateRequestPackageInfo extends PopBaseJsonEntity
{
	...
	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddWaybillUpdateRequest_ParamWaybillCloudPrintUpdateRequestPackageInfoItemsItem>, "items")
	*/
	private $items;
...
class PddWaybillUpdateRequest_ParamWaybillCloudPrintUpdateRequestRecipient extends PopBaseJsonEntity
{
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWaybillUpdateRequest_ParamWaybillCloudPrintUpdateRequestRecipientAddress, "address")
	*/
	private $address;
