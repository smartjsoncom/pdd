...
class PddGoodsLogisticsSerTemplateCreateRequest extends PopBaseHttpRequest
{
	...
	*/
	...
	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddGoodsLogisticsSerTemplateCreateRequest_ServiceAreaListItem>, "service_area_list")
	*/
	private $serviceAreaList;

	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddGoodsLogisticsSerTemplateCreateRequest_CatListItem>, "cat_list")
	*/
	private $catList;
...
class PddGoodsLogisticsSerTemplateCreateRequest_CatListItem extends PopBaseJsonEntity
{
	...
	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddGoodsLogisticsSerTemplateCreateRequest_CatListItemListItem>, "list")
	*/
	private $list;
...
class PddGoodsLogisticsSerTemplateCreateRequest_CatListItemListItem extends PopBaseJsonEntity
{
	...
	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddGoodsLogisticsSerTemplateCreateRequest_CatListItemListItemContentItem>, "content")
	*/
	private $content;
