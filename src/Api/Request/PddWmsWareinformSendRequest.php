...
class PddWmsWareinformSendRequest extends PopBaseHttpRequest
{
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWmsWareinformSendRequest_Request, "request")
	*/
	private $request;
...
class PddWmsWareinformSendRequest_Request extends PopBaseJsonEntity
{
	...
	*/
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWmsWareinformSendRequest_RequestWare, "ware")
	*/
	private $ware;
