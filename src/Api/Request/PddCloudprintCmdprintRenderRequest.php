...
class PddCloudprintCmdprintRenderRequest extends PopBaseHttpRequest
{
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddCloudprintCmdprintRenderRequest_Request, "request")
	*/
	private $request;
...
class PddCloudprintCmdprintRenderRequest_Request extends PopBaseJsonEntity
{
	...
	*/
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddCloudprintCmdprintRenderRequest_RequestConfig, "config")
	*/
	private $config;

	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddCloudprintCmdprintRenderRequest_RequestDocument, "document")
	*/
	private $document;
...
class PddCloudprintCmdprintRenderRequest_RequestDocument extends PopBaseJsonEntity
{
	...
	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddCloudprintCmdprintRenderRequest_RequestDocumentContentsItem>, "contents")
	*/
	private $contents;
