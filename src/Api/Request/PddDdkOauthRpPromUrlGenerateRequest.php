...
class PddDdkOauthRpPromUrlGenerateRequest extends PopBaseHttpRequest
{
	...
	*/
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddDdkOauthRpPromUrlGenerateRequest_DiyLotteryParam, "diy_lottery_param")
	*/
	private $diyLotteryParam;

	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddDdkOauthRpPromUrlGenerateRequest_DiyRedPacketParam, "diy_red_packet_param")
	*/
...
class PddDdkOauthRpPromUrlGenerateRequest_DiyLotteryParam extends PopBaseJsonEntity
{
	...
	*/
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddDdkOauthRpPromUrlGenerateRequest_DiyLotteryParamRangeItems, "range_items")
	*/
	private $rangeItems;
...
class PddDdkOauthRpPromUrlGenerateRequest_DiyRedPacketParam extends PopBaseJsonEntity
{
	...
	*/
	...
	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddDdkOauthRpPromUrlGenerateRequest_DiyRedPacketParamRangeItemsItem>, "range_items")
	*/
	private $rangeItems;
