...
class PddWmsReturnorderConfirmRequest extends PopBaseHttpRequest
{
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWmsReturnorderConfirmRequest_Request, "request")
	*/
	private $request;
...
class PddWmsReturnorderConfirmRequest_Request extends PopBaseJsonEntity
{
	...
	*/
	...
	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddWmsReturnorderConfirmRequest_RequestOrderLinesItem>, "orderLines")
	*/
	private $orderLines;
