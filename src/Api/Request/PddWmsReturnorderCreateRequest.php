...
class PddWmsReturnorderCreateRequest extends PopBaseHttpRequest
{
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWmsReturnorderCreateRequest_Request, "request")
	*/
	private $request;
...
class PddWmsReturnorderCreateRequest_Request extends PopBaseJsonEntity
{
	...
	*/
	...
	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddWmsReturnorderCreateRequest_RequestOrderLinesItem>, "orderLines")
	*/
	private $orderLines;
