...
class PddStockWareMoveRequest extends PopBaseHttpRequest
{
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddStockWareMoveRequest_StockMoveOrderActionDto, "stock_move_order_action_dto")
	*/
	private $stockMoveOrderActionDto;

	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddStockWareMoveRequest_StockMoveRecordActionDtoListItem>, "stock_move_record_action_dto_list")
	*/
