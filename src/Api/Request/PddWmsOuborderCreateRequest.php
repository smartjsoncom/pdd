...
class PddWmsOuborderCreateRequest extends PopBaseHttpRequest
{
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWmsOuborderCreateRequest_Request, "request")
	*/
	private $request;
...
class PddWmsOuborderCreateRequest_Request extends PopBaseJsonEntity
{
	...
	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddWmsOuborderCreateRequest_RequestOrderLineItem>, "orderLine")
	*/
	private $orderLine;

	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWmsOuborderCreateRequest_RequestOubOrder, "oubOrder")
	*/
	private $oubOrder;
...
class PddWmsOuborderCreateRequest_RequestOubOrder extends PopBaseJsonEntity
{
	...
	*/
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWmsOuborderCreateRequest_RequestOubOrderMallContracter, "mallContracter")
	*/
	...
	*/
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWmsOuborderCreateRequest_RequestOubOrderReceiverInfo, "receiverInfo")
	*/
	private $receiverInfo;

	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddWmsOuborderCreateRequest_RequestOubOrderRelatedOrdersItem>, "relatedOrders")
	*/
