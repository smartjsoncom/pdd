...
class PddGoodsAddRequest extends PopBaseHttpRequest
{
	...
	*/
	...
	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddGoodsAddRequest_SkuListItem>, "sku_list")
	*/
	private $skuList;
	...
	*/
	...
	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddGoodsAddRequest_GoodsPropertiesItem>, "goods_properties")
	*/
	...
	*/
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddGoodsAddRequest_OverseaGoods, "oversea_goods")
	*/
	...
	*/
	...
	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddGoodsAddRequest_CarouselVideoItem>, "carousel_video")
	*/
...
class PddGoodsAddRequest_SkuListItem extends PopBaseJsonEntity
{
	...
	*/
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddGoodsAddRequest_SkuListItemOverseaSku, "oversea_sku")
	*/
	private $overseaSku;
