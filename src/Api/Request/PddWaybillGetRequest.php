...
class PddWaybillGetRequest extends PopBaseHttpRequest
{
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWaybillGetRequest_ParamWaybillCloudPrintApplyNewRequest, "param_waybill_cloud_print_apply_new_request")
	*/
...
class PddWaybillGetRequest_ParamWaybillCloudPrintApplyNewRequest extends PopBaseJsonEntity
{
	...
	*/
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWaybillGetRequest_ParamWaybillCloudPrintApplyNewRequestSender, "sender")
	*/
	private $sender;

	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddWaybillGetRequest_ParamWaybillCloudPrintApplyNewRequestTradeOrderInfoDtosItem>, "trade_order_info_dtos")
	*/
...
class PddWaybillGetRequest_ParamWaybillCloudPrintApplyNewRequestSender extends PopBaseJsonEntity
{
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWaybillGetRequest_ParamWaybillCloudPrintApplyNewRequestSenderAddress, "address")
	*/
	private $address;
...
class PddWaybillGetRequest_ParamWaybillCloudPrintApplyNewRequestTradeOrderInfoDtosItem extends PopBaseJsonEntity
{
	...
	*/
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWaybillGetRequest_ParamWaybillCloudPrintApplyNewRequestTradeOrderInfoDtosItemOrderInfo, "order_info")
	*/
	private $orderInfo;

	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWaybillGetRequest_ParamWaybillCloudPrintApplyNewRequestTradeOrderInfoDtosItemPackageInfo, "package_info")
	*/
	private $packageInfo;

	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWaybillGetRequest_ParamWaybillCloudPrintApplyNewRequestTradeOrderInfoDtosItemRecipient, "recipient")
	*/
	private $recipient;
...
class PddWaybillGetRequest_ParamWaybillCloudPrintApplyNewRequestTradeOrderInfoDtosItemPackageInfo extends PopBaseJsonEntity
{
	...
	*/
	...
	/**
	* @JsonProperty(List<\SmartJson\Pdd\Api\Request\PddWaybillGetRequest_ParamWaybillCloudPrintApplyNewRequestTradeOrderInfoDtosItemPackageInfoItemsItem>, "items")
	*/
	private $items;
...
class PddWaybillGetRequest_ParamWaybillCloudPrintApplyNewRequestTradeOrderInfoDtosItemRecipient extends PopBaseJsonEntity
{
	...
	/**
	* @JsonProperty(\SmartJson\Pdd\Api\Request\PddWaybillGetRequest_ParamWaybillCloudPrintApplyNewRequestTradeOrderInfoDtosItemRecipientAddress, "address")
	*/
	private $address;
